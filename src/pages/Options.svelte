<script>
    ...
    import AdvancedSettings from "../components/options/AdvancedSettings.svelte";
...
>
    <!-- Sidebar Navigation -->
    <aside
        class="fixed left-0 top-0 w-64 h-screen bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 z-10"
    >
